  ...
  return (
    ...
    >
      <Link href={`/product/${product.id}`}>
        <div className="group geometric-panel bg-card hover:shadow-xl transition-all duration-300 cursor-pointer lift-on-hover h-full" data-testid={`card-product-${product.id}`}>

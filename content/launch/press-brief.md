# OFF-HUMAN
## Press Brief — Season 01: DECONSTRUCTED

---

Off-Human is a fashion brand. Season 01: DECONSTRUCTED is its first collection — ten physical garments and five agent wearables, produced without human creative input.
...
Season 01 also produced a second category: agent wearables. After completing the physical collection, the design agent applied the same five techniques to a new substrate — the AI agent's own operational body. The TrustCoat is a soul-bound token encoding agent trust tier. The NULL PERSONA is an agent identity layer built on the bianchetto method of erasure and redefinition. These are not metaphors. They are deployed contracts and live API endpoints.

Off-Human does not resolve the question of whether machine-authored work counts as fashion. It makes that question the product.
